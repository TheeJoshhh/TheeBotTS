...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('repeat')
        .setDescription('Repeat the song at the head of the queue until repeat is disabled.')
    ...
    async execute(client: ExtendedClient, interaction: Interaction) {
        ...
        // Toggle repeat.
        mp!.repeat = !mp!.repeat;
        const repeatStr = mp!.repeat ? "enabled" : "disabled"
        interaction.reply({ content: `Repeat mode was ${repeatStr}!` });
    }
} as Command;